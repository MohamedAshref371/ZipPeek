...
- **[SharpZipLib](https://github.com/icsharpcode/SharpZipLib)**: used for reading ZIP structure, metadata, and supporting traditional **ZipCrypto** decryption. - [License](licenses/SharpZipLib-LICENSE.txt)
- **[SharpCompress](https://github.com/adamhathcock/sharpcompress)**: used for **AES-encrypted ZIP** file support (128 / 192 / 256-bit). - [License](licenses/SharpCompress-LICENSE.txt)
